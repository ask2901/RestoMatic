    ...
    <>
      ...
      <div>
        <div class="flex flex-col gap-4 p-5 h-screen bg-slate-100">
          <div className="flex flex-row items-baseline justify-between px-4">
            <h1 class="text-xl mb-2">Products</h1>
            <Link href="/products/new" className="bg-amber-600 py-1 px-1 text-white rounded-lg">
              Add product
            </Link>
          </div>
            ...
            <table class="w-full">
              <thead class="bg-[#a3a3a3] border-b-2 border-gray-200">
                <tr>
                  ...
                  <th class="w-20 p-2 text-sm font-semibold tracking-wide text-center">Name</th>
                  <th class="w-20 text-sm font-semibold tracking-wide text-center">Description</th>
                  <th class="w-24 p-2 text-sm font-semibold tracking-wide text-center">Price</th>
                  <th class="w-16 p-2 text-sm font-semibold tracking-wide text-center">Edit</th>
